        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative" ref={dropdownRef}>
            <button
              ...
              className="flex items-center gap-2 p-1.5 rounded-xl hover:bg-gray-50 transition-colors cursor-pointer duration-150 group"
            >
              ...
              <span className="text-sm font-semibold text-gray-700 hidden sm:inline-block max-w-30 truncate">
                {user?.name || "Account"}
              </span>
              <ChevronDown
            ...
            {isDropdownOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-100 rounded-xl shadow-lg py-1 px-2 z-50 animate-in fade-in slide-in-from-top-1 duration-150">
                ...
                <button
                  ...
                  className="w-full text-left px-4 py-2.5 text-sm text-red-600 cursor-pointer hover:bg-red-50 font-medium flex items-center gap-2 transition-colors"
                >
